			...
			<div class="container">
				...
				<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span><i class="icon-plus"></i> Nouvel Utilisateur</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form id="mws-validate" class="mws-form" action="/userAdd" method="post">
                    		<div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
							<div class="mws-form-message warning" id="validate-warning" style="display:none;">
								<ul>
									<li id ="warningNomPrenom" style="display:none;">Un administrateur ou un utilisateur avec ce nom et pr&eacute;nom existe d&eacute;j&agrave; !</li>
									<li id ="warningLogin" style="display:none;">Ce login est d&eacute;j&agrave; pris !</li>
									<li id ="warningMail" style="display:none;">Cet email est d&eacute;j&agrave; pris !</li>
								</ul>
                            </div>
							<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				...
                    				<div class="mws-form-item">
                    					<input id="inputNom" type="text" class="small required" name="nom">
                    				</div>
                    			</div>
								<div class="mws-form-row">
                    				<label class="mws-form-label">Prenom : </label>
                    				<div class="mws-form-item">
                    					<input id="inputPrenom" type="text" class="small required" name="prenom">
                    				</div>
                    			</div>
				<!--				<div class="mws-form-row">
                    				<label class="mws-form-label">Login : </label>
                    				<div class="mws-form-item">
                    					<input id="inputLogin" type="text" class="small required" name="login">
                    				</div>
                    			</div> -->
								<div class="mws-form-row">
                    				<label class="mws-form-label">Mail : </label>
                    				<div class="mws-form-item">
                    					<input id="inputMail" type="text" class="small required" name="mail">
                    				</div>
                    			</div>
